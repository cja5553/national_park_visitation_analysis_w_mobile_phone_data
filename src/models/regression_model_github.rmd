...
population<-read.csv("population_data.csv") # read and merge the population dataset to include population
data<-merge(data,population, by.x="vistor_census_block",by.y="Geo_FIPS", all.x=T)
